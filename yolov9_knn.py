...
def make_parser():
    ...
    parser.add_argument(
        ...
        "--model",
        type=str,
        default="/home/sailhku/Desktop/yolov9/yolov9-c-converted.onnx",
    ...
    parser.add_argument(
        ...
        "--video_path",
        type=str,
        default='/home/sailhku/Desktop/yolov9/cutvideo.mp4',
        ...
        if ret_val:
            ...
            for output in outputs:
                ...
                if team_id == 1:
                    ...
                    team0_boxes.append(output)
                else:
                    team3_boxes.append(output)
