...
class LowSpeedChecker:
    ...
    def visualize(self, frame, idx):
        if self.flag == False:
            cv2.putText(frame, "Normal speed", (100, 100+(idx*40)), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2, cv2.LINE_AA)

        elif self.flag == True:
            cv2.putText(frame, "Low Speed", (100, 100+(idx*40)), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2, cv2.LINE_AA)
        # elif self.flag == 2:
