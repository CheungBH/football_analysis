...
cmd_tpl = "python yolov9_bytetrack_pth_4_cropping.py --save_cropped_humans {} --video_path {} --output_dir {} --save_asset --model_path {} --court_img {}"
...
for video in os.listdir(video_folder):
    ...
    cmd = cmd_tpl.format(save_cropped_path, video_path, output_dir, model_path, court_img)
    print(cmd)
    os.system(cmd)