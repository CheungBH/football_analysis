...
output_folder_root = r"D:\tmp\2.18_output2"
...
cmd_tpl = "python yolov9_bytetrack_pth_4_cropping.py --save_cropped_humans {} --video_path {} --use_json --output_dir {} --save_asset -m {} --court_image {} --show_video -o {}"
